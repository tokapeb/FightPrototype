...
namespace FullInspector.Samples.ProtoBufNet {
    ...
    public class SampleProtoCustomTypeEditorEditors :
        ...
        public override CustomTypeEditorNonGeneric Edit(Rect region, GUIContent label, CustomTypeEditorNonGeneric element) {
            EditorGUI.HelpBox(region, label.text + ": This is the non-generic editor", MessageType.Info);
            return element;
        }

        public override float GetElementHeight(GUIContent label, CustomTypeEditorNonGeneric element) {
            return 30;
        }
    }
    ...
    public class SampleProtoCustomTypeEditorEditors<T1, T2> :
        ...
        public override CustomTypeEditorGeneric<T1, T2> Edit(Rect region, GUIContent label, CustomTypeEditorGeneric<T1, T2> element) {
        ...
        public override float GetElementHeight(GUIContent label, CustomTypeEditorGeneric<T1, T2> element) {
            return 30;
        }
    }
    ...
    public class ICustomTypeEditorInheritedEditor<TDerived> : PropertyEditor<ICustomTypeEditorInherited> {
        ...
        public override ICustomTypeEditorInherited Edit(Rect region, GUIContent label, ICustomTypeEditorInherited element) {
        ...
        public override float GetElementHeight(GUIContent label, ICustomTypeEditorInherited element) {
            return 30;
        }
    }
}