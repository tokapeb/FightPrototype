...
namespace FullInspector.Samples.MinMaxSample {
    ...
    public class MinMaxEditor<TElement> : PropertyEditor<MinMax<TElement>> {
        ...
        public override MinMax<TElement> Edit(Rect region, GUIContent label, MinMax<TElement> element) {
        ...
        public override float GetElementHeight(GUIContent label, MinMax<TElement> element) {
